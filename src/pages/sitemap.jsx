  ...
  <>
    ...
    <Layout>
      ...
      <section>
        ...
        <article>
          <h2 className="lvl1"><div style={{ height: '3rem', width: '3rem', display: 'inline-block' }}><Icon type="house" color="blue" /></div><Link href={`${process.env.ASSET_PREFIX}/`}>About</Link></h2>
        </article>
        <article>
